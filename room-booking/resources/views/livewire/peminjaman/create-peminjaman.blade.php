<div class="container mx-auto">
    ...
    <form wire:submit.prevent="save" class="space-y-4">
        <flux:select id="pegawai_id" wire:model.defer="pegawai_id" label="Pegawai"
        ...
        <flux:select id="ruang_id" wire:model.defer="ruang_id" label="Ruang"
            placeholder="Pilih Ruang" required>
        ...
        <flux:input type="date" id="tanggal" wire:model.defer="tanggal" label="Tanggal"
            required />
