            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <h5>Nama Kartu: <?= $user['nama'] ?></h5>
                            <p><strong>Deskripsi:</strong> <?= $user['deskripsi'] ?></p>
                            <p><strong>Persen Diskon:</strong> <?= $user['persen_diskon'] ?>%</p>
                            <a href="list-kartuDiskon.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
                            <a href="edit-kartu-diskon.php?id=<?= $user['id'] ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
                            <a href="delete-kartu-diskon.php?id=<?= $user['id'] ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus kartu diskon ini?');"><i class="fas fa-trash-alt"></i> Hapus</a>
                        </div>
                    </div>
                </div>
            </main>
