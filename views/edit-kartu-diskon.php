...
if(isset($_POST['submit'])) {
    $data = [
        ...
        'persen_diskon' => $_POST['persenDiskon'],
    ];

    // Memanggil fungsi update pada model KartuDiskon
                        ...
                        <div class="card-body">
                            <form action="edit-kartu-diskon.php?id=<?= $user['id'] ?>" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="persenDiskon" name="persenDiskon" value="<?= $user['persen_diskon'] ?>" required>
                                </div>
                                <a href="list-kartuDiskon.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
